...
<div id ="sidebar" class="sidebar-nav panel panel-default toggled">
			  ...
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					<form id="saveform" action="add.php?table=Dati_iot" method="post">
			...
			<div class="modal fade" id="EditForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					<form id="editform" action="edit.php?table=Dati_iot" method="post">
    ...
    "ajax": "ambientj.php?table=Dati_iot",
	"columnDefs": [ {
    "targets": [3,4,5],
   ...
   "targets" : 2,
	...
	$('#remove').click( function(){
		...
		$.post( "delete.php?table=Dati_iot" , obj, function(info){ $("#resulted").html(info); });
		$('#EditForm').modal('hide');
		location.reload();
